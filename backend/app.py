    ...
    try:
        ...
        if is_gagansaathi or (from_airport and to_airport):
            prompt = (
                ...
                f"Deliver a warm, highly detailed, beautifully written response in complete, comprehensive narrative paragraphs for each section, focusing strongly on **destination airport ground transit, nearest hotels & prices, crime caution, nearest famous places, and famous foodlets**:\n\n"
                ...
                f"1. ✈️ **Destination Airport Transit, Flight Logistics & Ground Travel (Cab vs Metro)**:\n"
                f"   Write a detailed paragraph explaining flight distance and cruising duration (~1h 30m), followed by step-by-step origin airport check-in and security protocol. Provide a thorough guide on landing at the destination airport: following baggage reclaim signs to collect checked bags, and exact step-by-step choices for city transfer: **Destination Metro Line** (station location, token/card, transfer time to city center) vs **Official Airport Prepaid Taxi Kiosks** (fixed government-regulated fares, booking booth inside arrival hall) vs **App-Based Cab Pickup Zones** (Uber/Ola designated pickup bays, estimated fares).\n\n"
                ...
                f"4. 🍽️ **Famous Local Food Outlets Near Destination Airport & Allergy Guide**:\n"
                f"   Write a rich paragraph reviewing 3 renowned foodlets and iconic restaurants near the destination airport and downtown. Tailor recommendations strictly to **{food_pref or 'all dietary preferences'}** and provide strict allergy precautions for **{allergies or 'general safety'}**, detailing signature local dishes to savor, average pricing, and exact kitchen instructions.\n\n"

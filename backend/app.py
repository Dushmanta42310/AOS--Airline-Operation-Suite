...
def build_offline_gagansaathi_dossier(passenger_name, from_airport, to_airport, travel_date, trip_days, budget, food_pref, allergies, safety_notes):
    ...
    # Destination-specific curated multi-day datasets
    if city_name == "Kolkata":
        ...
        food_data = [
            {"name": "The Breakfast Club (Gachibowli)", "meal_type": "🥞 Breakfast (Day 1)", "type": "Dining", "cuisine": "South & North Indian", "special_dish": "Crisp Ghee Roast Idli-Dosa & Egg-Free Filter Coffee", "price_range": "₹250 / person", "weather_tag": "☀️ AC Dining Room", "why_recommended": "Hygienic morning breakfast hub offering fresh South Indian staples with zero allergen contamination.", "cautions_requirements": f"Kitchen honors {allergy_txt} notes strictly.", "map_query": "The Breakfast Club Gachibowli Hyderabad"},
            {"name": "Paradise Biryani (Near Airport / Secunderabad)", "meal_type": "🍲 Lunch (Day 1)", "type": "Non-Veg", "cuisine": "Authentic Hyderabadi", "special_dish": "Hyderabadi Chicken Biryani with Mirchi ka Salan (Zero fish/egg/mutton)", "price_range": "₹400 / person", "weather_tag": "☀️ AC Dining Room", "why_recommended": "World-famous heritage restaurant operating since 1953, celebrated for fragrant aromatic chicken biryani.", "cautions_requirements": "Request 'Chicken only' preparation with no boiled egg garnish.", "map_query": "Paradise Biryani Hyderabad"},
            {"name": "Chai Point & Nimrah Cafe (Charminar / Lounge)", "meal_type": "☕ Snacks (Day 1)", "type": "Dining", "cuisine": "Irani Cafe & Chai", "special_dish": "Irani Chai & Fresh Osmania Biscuits (Egg-Free)", "price_range": "₹120 / person", "weather_tag": "☀️ Covered Seating", "why_recommended": "Iconic Hyderabad tea culture experience with warm spiced chai and crisp butter biscuits.", "cautions_requirements": "Biscuits are baked egg-free; confirm with server.", "map_query": "Nimrah Cafe Charminar Hyderabad"},
            {"name": "Bawarchi (RTC Cross Roads / Gachibowli Branch)", "meal_type": "🍽️ Dinner (Day 1)", "type": "Non-Veg", "cuisine": "Mughlai & Tandoor", "special_dish": "Tandoori Chicken & Butter Garlic Naan (No seafood/mutton)", "price_range": "₹550 / person", "weather_tag": "☀️ AC Dining Room", "why_recommended": "Legendary culinary destination famous for smoky tandoori kebabs and rich butter chicken gravies.", "cautions_requirements": "State allergy preferences clearly to table captain.", "map_query": "Bawarchi Restaurant RTC Cross Roads Hyderabad"},
            {"name": "Chutneys (Banjara Hills)", "meal_type": "🥞 Breakfast (Day 2)", "type": "Veg", "cuisine": "South Indian Specialty", "special_dish": "Steam Dosa & 6 Varietal Herbal Chutneys", "price_range": "₹300 / person", "weather_tag": "☀️ AC Dining", "why_recommended": "Celebrated fine-dining South Indian hub famous for its 6 unique chutney platters.", "cautions_requirements": "All items pure vegetarian.", "map_query": "Chutneys Banjara Hills Hyderabad"},
            {"name": "Shadab Restaurant (Ghansi Bazaar)", "meal_type": "🍽️ Dinner (Day 2)", "type": "Non-Veg", "cuisine": "Old City Mughlai", "special_dish": "Murgh Malai Kebab & Romali Roti", "price_range": "₹450 / person", "weather_tag": "☀️ AC Family Hall", "why_recommended": "Old-city culinary icon renowned for royal Nizami flavours and tender chicken kebabs.", "cautions_requirements": "Specify non-spicy preparation if preferred.", "map_query": "Shadab Restaurant Ghansi Bazaar Hyderabad"}
        ]
        places_data = [
            {"name": "Charminar & Laad Bazaar", "type": "16th-Century Mosque & Heritage Market (Day 2 Morning)", "best_time": "08:00 AM – 10:00 AM (Cool Morning Hours)", "entry_fee": "₹25 (Indian) / ₹300 (Foreigner)", "weather_tag": "⛅ Historic Landmark", "why_recommended": "The global emblem of Hyderabad surrounded by bustling bangles markets and historic Irani cafes.", "cautions_requirements": "Visit early to avoid peak afternoon heat; keep valuables secure in markets.", "map_query": "Charminar Hyderabad"},
            {"name": "Golconda Fort & Sound-Light Show", "type": "Medieval Hilltop Fortification (Day 2 Evening)", "best_time": "04:30 PM – 06:30 PM (Sunset & Acoustic Marvels)", "entry_fee": "₹25 (Entry) + ₹140 (Light Show)", "weather_tag": "⛅ Hilltop Viewpoint", "why_recommended": "Majestic fortress renowned for its acoustic engineering, diamond vaults, and panoramic sunset views.", "cautions_requirements": "Wear sports shoes for the climb; carry bottled water.", "map_query": "Golconda Fort Hyderabad"},
            {"name": "Hussain Sagar Lake & Buddha Statue", "type": "Heart-Shaped Lake & Monolithic Statue (Day 1 Sunset)", "best_time": "05:00 PM – 07:30 PM (Evening Speedboat Ride)", "entry_fee": "₹75 (Boat Ride)", "weather_tag": "⛅ Scenic Promenade", "why_recommended": "World's tallest monolithic Buddha statue standing in the center of the lake with pleasant breeze on Necklace Road.", "cautions_requirements": "Life jackets mandatory during speedboat boarding.", "map_query": "Hussain Sagar Lake Hyderabad"},
            {"name": "Salar Jung Museum", "type": "World's Largest One-Man Art Collection (Day 2 Mid-Day)", "best_time": "11:00 AM – 03:00 PM (AC Galleries)", "entry_fee": "₹50 (Indian) / ₹500 (Foreigner)", "weather_tag": "☔ 100% Indoor AC Landmark", "why_recommended": "Immense museum housing the famous Veiled Rebecca, musical clock, and 38 antique galleries.", "cautions_requirements": "Baggage deposit required at main gate.", "map_query": "Salar Jung Museum Hyderabad"},
            {"name": "Ramoji Film City (East Hyderabad)", "type": "World's Largest Themed Film City (Day 3)", "best_time": "09:30 AM – 04:30 PM (Full Day Tour)", "entry_fee": "₹1,350 (Guided Day Pass)", "weather_tag": "☀️ Themed Attractions", "why_recommended": "Guinness Record-holding studio complex with stunt shows, film sets, and Japanese gardens.", "cautions_requirements": "Book tickets online in advance to skip queue lines.", "map_query": "Ramoji Film City Hyderabad"}
        ]
        hospitals_data = [
        ...
        food_data = [
            {"name": f"The Grand Breakfast Kitchen ({city_name})", "meal_type": "🥞 Breakfast (Day 1)", "type": "Dining", "cuisine": "Multi-Cuisine Breakfast", "special_dish": "Steamed Idli-Vada, Poha & Fresh Juices", "price_range": "₹250 / person", "weather_tag": "☀️ AC Dining Room", "why_recommended": "Hygienic morning restaurant offering freshly prepared hot breakfast staples with allergy care.", "cautions_requirements": f"Strict adherence to {allergy_txt}.", "map_query": f"Breakfast Restaurant {city_name}"},
            {"name": f"Royal Heritage Restaurant ({city_name})", "meal_type": "🍲 Lunch (Day 1)", "type": "Non-Veg", "cuisine": "Authentic Regional Cuisine", "special_dish": f"Special {city_name} Chicken Thali (No fish/mutton)", "price_range": "₹380 / person", "weather_tag": "☀️ AC Dining Room", "why_recommended": "Top-rated family restaurant serving wholesome, flavorful chicken and vegetarian meals.", "cautions_requirements": f"Informed kitchen regarding {allergy_txt}.", "map_query": f"Famous Restaurant {city_name}"},
            {"name": f"Chai & Bakery Lounge ({city_name})", "meal_type": "☕ Snacks (Day 1)", "type": "Dining", "cuisine": "Tea Lounge & Snacks", "special_dish": "Hot Masala Chai & Baked Egg-Free Savories", "price_range": "₹150 / person", "weather_tag": "☀️ Covered Seating", "why_recommended": "Comfortable tea house for evening relaxation, aromatic tea blends, and light refreshments.", "cautions_requirements": "Egg-free baking certified on menu.", "map_query": f"Tea Lounge {city_name}"},
            {"name": f"The Sizzler & Grill Fine Dining ({city_name})", "meal_type": "🍽️ Dinner (Day 1)", "type": "Non-Veg", "cuisine": "Continental & Mughlai", "special_dish": "Grilled Herb Chicken with Garlic Breads (No seafood/egg)", "price_range": "₹600 / person", "weather_tag": "☀️ AC Dining Room", "why_recommended": "Sophisticated evening dinner venue with tranquil ambience and curated single-protein dishes.", "cautions_requirements": "Pre-inform server about food restrictions.", "map_query": f"Fine Dining Restaurant {city_name}"},
            {"name": f"Heritage Garden Cafe ({city_name})", "meal_type": "🍲 Lunch (Day 2)", "type": "Dining", "cuisine": "Regional Delicacies", "special_dish": "Homestyle Thali & Fresh Fruit Dessert", "price_range": "₹350 / person", "weather_tag": "☀️ AC Seating", "why_recommended": "Cozy garden-themed eatery serving fresh organic regional meals.", "cautions_requirements": "Strictly vegetarian/chicken preparation on request.", "map_query": f"Garden Cafe {city_name}"},
            {"name": f"Royal Tandoor House ({city_name})", "meal_type": "🍽️ Dinner (Day 2)", "type": "Non-Veg", "cuisine": "Tandoor & Mughlai", "special_dish": "Murgh Tikka with Butter Naan", "price_range": "₹500 / person", "weather_tag": "☀️ AC Dining", "why_recommended": "Popular family dining hotspot known for aromatic charcoal grills and curries.", "cautions_requirements": "Allergen notes passed directly to kitchen.", "map_query": f"Tandoor Restaurant {city_name}"}
        ]
        places_data = [
            {"name": f"{city_name} Heritage Monument & Central Museum", "type": "Historical Landmark (Day 2 Morning)", "best_time": "08:00 AM – 10:30 AM (Morning Hours)", "entry_fee": "₹30 – ₹50", "weather_tag": "⛅ Historic Landmark", "why_recommended": "The prime architectural landmark showcasing the rich heritage, art, and history of the region.", "cautions_requirements": "Carry umbrella for open courtyard walks.", "map_query": f"Famous Places in {city_name}"},
            {"name": f"{city_name} Scenic Riverfront / Lake Promenade", "type": "Waterfront Viewpoint (Day 1 Sunset)", "best_time": "05:30 PM – 07:30 PM (Sunset & Twilight)", "entry_fee": "Free Access", "weather_tag": "⛅ Waterfront Breeze", "why_recommended": "Breathtaking waterfront viewpoint offering cool evening breezes, illumination, and boat rides.", "cautions_requirements": "Stay on marked paved walkways.", "map_query": f"Waterfront in {city_name}"},
            {"name": f"{city_name} Cultural Centre & Art Gallery", "type": "Indoor Museum (Day 2 Mid-Day)", "best_time": "11:30 AM – 03:30 PM (Mid-Day AC Comfort)", "entry_fee": "₹50 per visitor", "weather_tag": "☔ 100% Indoor AC Landmark", "why_recommended": "State-of-the-art exhibition halls presenting regional handicrafts, space science, and paintings.", "cautions_requirements": "Ideal indoor retreat during humid afternoon hours.", "map_query": f"Museum in {city_name}"},
            {"name": f"{city_name} Botanical Urban Park & Eco Gardens", "type": "Sprawling Green Ecological Reserve (Day 2 Evening)", "best_time": "04:00 PM – 06:30 PM (Evening Leisure)", "entry_fee": "₹20 – ₹30", "weather_tag": "⛅ Open Garden", "why_recommended": "Lush green oasis with musical fountains, rose gardens, and paved jogging tracks.", "cautions_requirements": "Comfortable footwear recommended.", "map_query": f"Eco Park in {city_name}"},
            {"name": f"{city_name} Artisan Crafts Bazaar & Souvenir Market", "type": "Cultural Handicrafts Hub (Day 3)", "best_time": "09:30 AM – 12:30 PM (Morning Shopping)", "entry_fee": "Free Access", "weather_tag": "⛅ Covered Market", "why_recommended": "Vibrant market for authentic handlooms, silk fabrics, local sweets, and handcrafted souvenirs.", "cautions_requirements": "Bargain politely; keep wallets secure.", "map_query": f"Crafts Market {city_name}"}
        ]
        hospitals_data = [
    ...
    weather_days = [
        {"day": "Day 1 (Arrival & Riverside)", "temp": "29°C – 33°C", "rain_probability": "65%", "condition": "Partly cloudy with intermittent monsoon showers", "activity_advice": "Carry windproof compact umbrella; utilize indoor air-conditioned hotel transit during peak afternoon downpours."},
        {"day": "Day 2 (Monuments & Museums)", "temp": "28°C – 32°C", "rain_probability": "50%", "condition": "Warm with occasional afternoon drizzle", "activity_advice": "Wear breathable quick-dry clothing; ideal for early morning architectural walks and air-conditioned indoor science museums."},
        {"day": "Day 3 (Shopping & Departure)", "temp": "27°C – 31°C", "rain_probability": "35%", "condition": "Mostly pleasant breeze with sunny intervals", "activity_advice": "Carry UV sunglasses and sunscreen; perfect for morning souvenir markets and seamless express metro airport transit."}
    ]

    # Construct the authoritative multi-day continuous narrative Markdown with interactive entity names
    narrative = f"""Namaste & Warm Greetings, **{p_name}**! 🙏
Welcome to **Gagan Saathi (गगन साथी)** — your trusted Aviation Operations & Travel Intelligence Companion for Airline Operation Suite (AOS). We are delighted to present your comprehensive end-to-end travel blueprint for your **{t_days}** journey from **{from_apt}** to **{to_apt}** on **{t_date}**.

🚨 **Immediate Safety & Emergency Helplines (Save on Speed-Dial)**:
For your complete peace of mind, please save these emergency helplines before leaving home. Dial `112` or `100` for all-India police assistance, `108` for rapid emergency medical ambulance dispatch and trauma care, `181` for 24/7 dedicated women safety support, `1800-180-1234` for CISF Airport Security Control, and `1800-425-2026` for AOS Aviation Concierge services. Keep a printed copy of these numbers in your cabin hand baggage alongside your government identification documents.

---

### 🌟 **7-Line Executive Trip Highlights & Interactive Overview**:
1. ✈️ **Flight Logistics & Departure Protocol**: Web check-in 24h prior, 2.5h traffic buffer to **{from_apt}**, digital boarding pass with ID proof, 15 kg checked baggage allowance, and power banks/laptops in cabin bag.
2. 🚇 **Destination Arrival & Ground Transit**: Touchdown at **{to_apt}**, collect baggage from carousels, and transit via **Airport Metro** (₹30–₹60, 25-35 min) or **Official Prepaid Taxi Kiosk** (₹350–₹650) directly to your hotel.
3. 🌦️ **Predictive Weather & Prevention Action**: Expect temperatures of **{weather_days[0]['temp']}** with **{weather_days[0]['rain_probability']} rain probability** — carry a windproof umbrella, wear breathable quick-dry attire, and plan indoor AC visits at **{places_data[2]['name']}** during afternoon downpours.
4. 🛡️ **Crime Rate Caution & Women Night Safety**: Moderate Caution status — stick to illuminated main expressways, refuse unmetered arrival touts, use GPS tracked rides, and keep speed-dial `112` & `181` active.
5. 🏨 **Budget-Matched Hotel Living**: Safe 24/7 AC accommodations at **{hotels_data[0]['name']}** ({hotels_data[0]['distance']}, {hotels_data[0]['price']}) or **{hotels_data[1]['name']}** with soundproof comfort and express check-in.
6. 🍽️ **Meal-by-Meal Regional Gastronomy**: Savor {f_pref} meals at **{food_data[0]['name']}** (Breakfast), **{food_data[1]['name']}** (Lunch), **{food_data[2]['name']}** (High Tea), and **{food_data[3]['name']}** (Dinner) with {allergy_txt} safeguards.
7. 📍 **Monuments & Emergency Healthcare**: Explore **{places_data[0]['name']}** ({places_data[0]['best_time']}) and **{places_data[1]['name']}** with 24/7 medical backup at **{hospitals_data[0]['name']}** (`{hospitals_data[0]['emergency_phone']}`).

---

### 1. ✈️ **Origin Airport Departure Protocol, Flight Logistics & Destination Ground Transit Roadmap**:
Your flight journey from {from_apt} to {to_apt} spans an estimated direct cruising distance of approximately 450–850 km, with an average non-stop block time of 1 hour 30 minutes. Before leaving home, complete your mandatory web check-in 24 hours prior to departure, save your digital boarding pass on your smartphone, carry an original government-issued photo ID (Aadhaar, PAN, or Passport), and strictly ensure that all portable power banks, lithium batteries, and laptops are packed inside your hand cabin baggage, as civil aviation safety regulations strictly prohibit lithium batteries in checked luggage. Plan to depart for {from_apt} at least 2 to 2.5 hours before departure to buffer for city highway traffic, seamlessly navigating airport terminal entry verification, airline baggage drop counters (with a standard 15 kg checked baggage allowance), and CISF security screening trays where electronics and jackets must be placed separately.

Upon smooth touchdown at {to_apt}, follow the overhead illuminated 'Baggage Claim' signs to collect your checked bags from the designated carousel before proceeding to the Arrival Concourse. For your ground transit into {city_name} city center, you have three vetted transit methods. First, the dedicated **Destination Airport Metro Line** connects directly from the terminal concourse, with air-conditioned trains departing every 8–10 minutes with smart-card or token ticketing (₹30–₹60), taking just 25–35 minutes to reach downtown while completely bypassing congested arterial highway traffic. Second, the **Official Airport Prepaid Taxi Kiosks** located inside the arrival hall before exit gates offer transparent government-regulated fares (₹350–₹650) with verified police-registered drivers and printed physical receipts. Third, **App-Based Cabs (Uber and Ola)** operate from designated pickup forecourt bays, where you can verify the vehicle registration plate and OTP before boarding (fares typically range ₹300–₹600 depending on real-time traffic surge). For your initial arrival with heavy luggage, the official prepaid taxi or app-cab provides direct hotel doorstep drop-off, while the airport metro serves as the most efficient, traffic-free option for subsequent daily city travel.

---

### 2. 📅 **Day-by-Day Travel Itinerary with Daily Precautions, Problem Solvers & Food Variety**:

#### 🌅 **Day 1: Arrival Touchdown, Hotel Check-in, Riverside Twilight & Authentic Flavors**:
🛡️ **Day 1 Essential Precautions**: *Keep your original travel documents zipped inside your front body pouch; avoid individual touts soliciting rides outside arrival exit doors; use only prepaid kiosk taxis or app-tracked cabs; save your live GPS ride link with family members.*
Upon arrival at {to_apt}, proceed to check into your room at **{hotels_data[0]['name']}** (located {hotels_data[0]['distance']} with soundproof AC comfort and 24/7 security). **Common Day 1 Travel Problems & Immediate Solutions**: If you experience post-flight dehydration or physical fatigue from carrying baggage, take advantage of the hotel's express check-in luggage drop and hydrate with complimentary bottled water before setting out; if initial midday traffic is heavy along the main expressway, utilize the direct airport metro for rapid city transit. For **Breakfast (7:00 AM – 10:00 AM)**, visit **{food_data[0]['name']}** for {food_data[0]['special_dish']} ({food_data[0]['why_recommended']}). For a wholesome **Lunch (12:30 PM – 3:30 PM)**, relish authentic flavors at **{food_data[1]['name']}** featuring {food_data[1]['special_dish']} with strict adherence to your {f_pref} preference and {allergy_txt} safeguards. During late afternoon, refresh with **Evening High Tea (4:30 PM – 6:30 PM)** at **{food_data[2]['name']}** savoring {food_data[2]['special_dish']}. At sunset (5:30 PM – 7:00 PM), stroll along the picturesque waterfront at **{places_data[1]['name']}**, {places_data[1]['why_recommended']}. Conclude your first evening with a peaceful **Dinner (7:30 PM – 10:30 PM)** at **{food_data[3]['name']}**, dining on {food_data[3]['special_dish']}.

#### 🏛️ **Day 2: Full-Day Heritage Marvels, Indoor AC Science Exhibits & Lakeside Relaxation**:
🛡️ **Day 2 Essential Precautions**: *Carry your compact windproof umbrella and SPF 50 sunscreen; stay alert against pickpockets in dense old-city markets; drink only packaged mineral water; solo and women travelers should stick to well-lit primary expressways when returning after 20:00 hrs.*
Start your morning early (7:00 AM – 9:30 AM) to experience the cool breeze and magnificent white marble architecture of **{places_data[0]['name']}** ({places_data[0]['why_recommended']}, entry: {places_data[0]['entry_fee']}). **Common Day 2 Travel Problems & Immediate Solutions**: If intense afternoon humidity or sudden monsoon showers occur between 11:30 AM and 3:30 PM, immediately transition into the 100% air-conditioned interactive exhibition halls at **{places_data[2]['name']}** ({places_data[2]['why_recommended']}), completely shielding yourself from rain and heat; if old-city road traffic gets congested, take the rapid metro line instead of road taxis. For **Lunch (12:30 PM – 3:30 PM)**, savor traditional delicacies at **{food_data[4]['name']}** enjoying {food_data[4]['special_dish']}. In the late afternoon (4:00 PM – 6:30 PM), explore the sprawling lakeside grounds, replicas of the Seven Wonders, and musical fountains at **{places_data[3]['name']}** ({places_data[3]['why_recommended']}). Conclude your day with a celebrated feast at **{food_data[5]['name']}**, relishing {food_data[5]['special_dish']} ({food_data[5]['why_recommended']}).

#### 🛍️ **Day 3: Artisan Handicrafts, Cultural Souvenirs & Smooth Airport Return**:
🛡️ **Day 3 Essential Precautions**: *Confirm your flight departure terminal and gate number online; ensure your checked baggage weighs within the 15 kg limit; buffer your airport arrival time by at least 2.5 hours before departure to avoid missing your flight.*
Begin your final day with a relaxed morning breakfast at your hotel or local cafe. Head to **{places_data[4]['name']}** ({places_data[4]['why_recommended']}) between 9:00 AM and 12:00 PM to shop for authentic regional handlooms, silks, handcrafted artifacts, and regional sweets. **Common Day 3 Travel Problems & Immediate Solutions**: If returning to the airport during peak highway traffic hours, bypass road bottlenecks entirely by taking the direct Airport Express Metro, ensuring you reach the departure terminal in 25–35 minutes without any traffic stress; ensure all newly purchased battery-operated gadgets and power banks are packed strictly into your cabin hand luggage. After completing a relaxed farewell lunch, check out of your hotel and head smoothly to {to_apt} for baggage drop, CISF security clearance, and your boarding gate.

---

### 3. 🛡️ **Destination Crime Rate Caution, Night Transit & Women/Solo Passenger Safety**:
The precinct surrounding {to_apt} is comprehensively monitored by CISF security forces and state highway police patrols, making daytime and early evening transit very safe. However, standard urban precautions are strongly advised after dark (post 20:00 hrs) around airport access corridors, isolated suburban bypass roads, and secluded transit junctions. Never entertain or follow unauthorized individual touts who solicit rides inside or immediately outside the arrival gates, as they operate unmetered vehicles without verified commercial licenses or GPS tracking. When traveling after dark, always utilize pre-booked official kiosk taxis or app-tracked cabs and share your live GPS ride tracking link with family members or colleagues. Solo travelers and women passengers should stick strictly to brightly illuminated primary arterial expressways (such as VIP Road, Major Arterial Road, and Eastern Expressways) and utilize the built-in emergency SOS buttons available within verified ride-hailing apps. In any urgent situation, immediately contact the local police helpline (`112` / `100`), the Women Safety Helpline (`181`), or the 24/7 CISF Airport Security booth (`1800-180-1234`). Destination safety is categorized as **Moderate Caution** with standard urban awareness.

---

### 4. 🏨 **Nearest Recommended Hotels to Destination Airport & Budget Guidance**:
To ensure maximum convenience, safety, and budget alignment with your **{b_tier}** preference, several outstanding properties are situated within close reach of {to_apt}. For high proximity and full service, **{hotels_data[0]['name']}** is located just {hotels_data[0]['distance']}, providing soundproofed air-conditioned rooms, 24-hour reception, complimentary high-speed Wi-Fi, and round-the-clock room service with nightly tariffs averaging **{hotels_data[0]['price']}** ({hotels_data[0]['why_recommended']}). For upscale comfort in the prime urban commercial district, **{hotels_data[1]['name']}** is positioned {hotels_data[1]['distance']}, featuring modern decor, multi-cuisine dining, a fitness center, and express laundry services with room tariffs around **{hotels_data[1]['price']}** ({hotels_data[1]['why_recommended']}). For budget-conscious travelers seeking smart lean luxury with immediate transit connectivity, **{hotels_data[2]['name']}** is located {hotels_data[2]['distance']} along the primary arterial metro corridor, offering spotless air-conditioned rooms, electronic keycard security, and wholesome breakfast options averaging **{hotels_data[2]['price']}** per night ({hotels_data[2]['why_recommended']}). All recommended properties provide 24-hour front desk assistance, CCTV surveillance, and dietary-friendly kitchens accustomed to handling passenger allergen notes.

---

### 5. 🌤️ **Multi-Day Weather Predictions, Gear Checklist & Weather Adaptation Plan**:
During your **{t_days}** stay in {city_name} starting {t_date}, expect monsoon-transition weather with warm temperatures averaging between 27°C and 33°C, relative humidity ranging from 70% to 85%, and intermittent passing showers. Specifically, **{weather_days[0]['day']}** will experience temperatures around {weather_days[0]['temp']} with a {weather_days[0]['rain_probability']} rain probability ({weather_days[0]['condition']}), making it essential to {weather_days[0]['activity_advice']}. On **{weather_days[1]['day']}**, expect {weather_days[1]['temp']} with {weather_days[1]['rain_probability']} rain probability ({weather_days[1]['condition']}), where the best plan is to {weather_days[1]['activity_advice']}. On **{weather_days[2]['day']}**, pleasant breezes and sunny intervals with temperatures around {weather_days[2]['temp']} and a {weather_days[2]['rain_probability']} rain chance ({weather_days[2]['condition']}) will create ideal conditions to {weather_days[2]['activity_advice']}. To effectively manage unexpected weather shifts, always pack a compact windproof umbrella or light waterproof jacket, wear breathable quick-dry cotton clothing, carry UV sunglasses and SPF 50 sunscreen for sunny intervals, and schedule indoor museum visits during peak mid-day rain or heat while reserving outdoor promenades for morning and twilight hours.

---

### 6. 🏥 **Nearest 24/7 Emergency Hospitals & Medical Care Infrastructure**:
In the event of any medical urgency, sudden illness, or trauma requirement during your journey, top multi-specialty healthcare centers located near {to_apt} and downtown provide round-the-clock emergency medical response and ICU facilities. **{hospitals_data[0]['name']}** is situated just **{hospitals_data[0]['distance']}**, offering 24/7 emergency trauma, cardiology, and critical care units reachable directly at **`{hospitals_data[0]['emergency_phone']}`**. For acute multi-specialty care and comprehensive ICU support, **{hospitals_data[1]['name']}** is located **{hospitals_data[1]['distance']}**, operating an emergency trauma hotline at **`{hospitals_data[1]['emergency_phone']}`**. Additionally, **{hospitals_data[2]['name']}** is positioned **{hospitals_data[2]['distance']}**, delivering state-of-the-art emergency trauma, diagnostic, and specialty intensive care with 24-hour helpline access at **`{hospitals_data[2]['emergency_phone']}`**. For immediate citywide ambulance dispatch anywhere across the region, dial `108` or `112`.
"""
    ...
    for m in models:
        try:
            req_data = {
                "model": m,
                "messages": [
                    {"role": "system", "content": "You are Gagan Saathi (गगन साथी), the elite AI Travel Intelligence & Flight Operations Companion of Airline Operation Suite (AOS). FORMAT INSTRUCTION: You MUST present the entire response in rich, cohesive, lengthy NARRATIVE PARAGRAPHS for each section. DO NOT use bullet points (•, -, *), numbered lists, or short lines in your narrative text. Write comprehensive flowing paragraphs detailing origin airport procedures, destination airport arrival and transit comparisons (Metro vs Prepaid Taxi vs App-cabs), night & women crime safety, budget hotels, breakfast-to-dinner dining with food outlets & allergy care, famous monuments, multi-day weather predictions & adaptation plans, and 24/7 hospitals. Conclude with the ```json_travel_data block containing rich structured cards data."},
    ...
    try:
        ...
        if is_gagansaathi or (from_airport and to_airport):
            prompt = (
                ...
                f"### INSTRUCTIONS FOR YOUR RESPONSE (WRITE IN LENGTHY, DEEPLY DETAILED NARRATIVE PARAGRAPHS — DO NOT USE BULLET POINTS OR SHORT LINES):\n"
                f"Deliver a warm, expansive, highly detailed response written entirely in rich, continuous narrative paragraphs for each section. Provide extensive details on origin airport protocols, destination airport arrival and ground transit comparisons (Metro vs Prepaid Taxi vs App Cabs), a day-by-day travel itinerary with precautions on top for every day and real-time travel problem solutions (tackling fatigue, weather shifts, traffic bottlenecks, hydration), meal-by-meal dining variety (Breakfast, Lunch, Snacks, Dinner) for each travel day with food outlets & regional food, crime caution & night/women safety, nearest hotels & tariffs, multi-day weather predictions, famous monuments, and 24/7 hospitals:\n\n"
                ...
                f"🚨 **Immediate Safety & Emergency Contacts**: Include an introductory safety paragraph listing police (`112`/`100`), ambulance (`108`), women safety (`181`), and CISF airport security (`1800-180-1234`).\n\n"
                f"🌟 **7-Line Executive Trip Highlights & Interactive Overview**:\n"
                f"Immediately following the emergency numbers, create a section titled '### 🌟 **7-Line Executive Trip Highlights & Interactive Overview**:' containing exactly 7 numbered lines summarizing: 1. Flight Departure & Baggage, 2. Destination Arrival & Metro/Prepaid Transit, 3. Predictive Weather & Preventive Gear Action, 4. Crime Caution & Night/Women Safety, 5. Nearest Budget Hotels & Tariffs, 6. Meal-by-Meal Regional Gastronomy & Allergies, and 7. Famous Monuments & 24/7 Hospitals.\n\n"
                f"1. ✈️ **Origin Airport Departure Protocol, Flight Logistics & Destination Ground Transit Roadmap**:\n"
                f"   Write an extensive, continuous narrative paragraph explaining estimated flight distance and cruising duration (~1h 30m), pre-departure home preparation (traffic buffer, 24h web check-in, digital boarding pass, government ID proof, and packing powerbanks/laptops strictly in hand luggage), origin terminal entry, baggage drop counter protocol (15 kg checked baggage allowance), CISF security trays, and boarding timing. In the same flowing section, provide a complete guide upon landing at the destination airport: following baggage reclaim signs to collect checked bags at carousels, and a detailed transit comparison woven into continuous paragraphs comparing the **Destination Metro Line** (station location, token/smart-card, direct transit time to city center) vs **Official Airport Prepaid Taxi Kiosks** (fixed government-regulated fares, booking booth inside arrival hall) vs **App-Based Cab Pickup Zones** (Uber/Ola designated pickup bays, estimated fares).\n\n"
                f"2. 📅 **Day-by-Day Travel Itinerary with Daily Precautions, Problem Solvers & Food Variety**:\n"
                f"   Write comprehensive, expansive narrative subsections for **Day 1**, **Day 2**, and **Day 3** (or the full trip duration). For EACH day:\n"
                f"   • Put **Daily Essential Precautions on TOP** of that day (baggage security, scams, hydration, weather protection, women & night travel safety).\n"
                f"   • Detail the **Morning, Afternoon, and Evening Schedule** with distinct activities, monuments, and viewpoints.\n"
                f"   • Detail **Common Travel Problems for that specific day & Immediate Solutions** (e.g., flight fatigue & luggage handling, sudden rain/humidity shifts, old-city traffic bottlenecks, return airport rush).\n"
                f"   • Detail **Daily Food Variety** across all 4 meals (Breakfast, Lunch, Snacks/High Tea, Dinner) naming specific famous food outlets and regional dishes tailored to {food_pref} with strict allergy safeguards for {allergies}.\n\n"
                f"3. 🛡️ **Destination Airport Crime Caution & Night Safety Handbook**:\n"
                f"   Write a comprehensive narrative paragraph covering crime caution and safety around the destination airport and city after dark. Detail night transit precautions, which areas to avoid late at night, strictly avoiding unlicensed drivers and touts outside arrival gates, sticking to well-lit main arterial roads, safety rules for solo travelers and women passengers, and emergency contacts.\n\n"
                f"4. 🏨 **Nearest Hotels to Destination Airport & Budget Guidance**:\n"
                f"   Write a continuous narrative paragraph reviewing 3 top-rated hotels situated nearest to the destination airport or along the direct metro corridor. Match the budget tier ({budget or 'Moderate'}), specifying their exact distance from the airport (e.g. 2–5 km), estimated nightly room tariffs (e.g. ₹2,500–₹4,200/night), AC amenities, security, and why they offer comfortable, safe living.\n\n"
                f"5. 🌤️ **Multi-Day Weather Predictions, Gear Checklist & Weather Adaptation Plan**:\n"
                f"   Write a comprehensive narrative paragraph providing the day-by-day weather forecast for **{trip_days}** with temperatures, rain probability, humidity, gear recommendations (e.g. ☔ Umbrella / Raincoat for wet hours, 🕶️ Sunglasses/Sunscreen for sunny afternoons, light clothing), and proactive advice on how to adapt travel plans for weather problems (e.g., visiting indoor museums during rain showers and scheduling outdoor strolls in the cool mornings/evenings).\n\n"
                f"6. 🏥 **Nearest 24/7 Emergency Hospitals & Medical Care Infrastructure**:\n"
                f"   Write a continuous narrative paragraph detailing 3 top multi-specialty emergency hospitals closest to the destination airport and downtown with 24/7 trauma care, emergency helplines, and ambulance connectivity.\n\n"

    ...
    try:
        ...
        if is_gagansaathi or (from_airport and to_airport):
            prompt = (
                ...
                f"6. 🌤️ **Comprehensive All-Journey-Days Weather, Daily Caution & Preventive Gear Advisory**:\n"
                f"   Write an extensive, day-by-day weather breakdown covering EVERY SINGLE DAY of the traveler's **{trip_days}** (Day 1, Day 2, Day 3, etc.). For every day, detail:\n"
                f"   • 🌡️ Expected Temperature range & Humidity levels\n"
                f"   • 🌧️ Rain Probability (%) and Sky Condition (e.g. Sunny, Overcast Showers, Thunderstorms)\n"
                f"   • ⚠️ **Specific Daily Caution & Hazards** (e.g. peak afternoon UV heat, slippery streets, sudden downpours, waterlogging)\n"
                f"   • 🎒 **Mandatory Preventive Packing & Health Gear** (e.g. ☔ Windproof umbrella, waterproof shoes/covers, breathable quick-dry attire, SPF 50 sunscreen, hydration electrolytes)\n"
                f"   • 🧭 **Weather-Matched Activity Advice** (indoor air-conditioned cultural halls/museums during rain/heat, open gardens/heritage walks during pleasant morning/evening hours).\n\n"
                ...
                f"'weather_forecast_days': array of objects for EACH DAY of the trip with ('day', 'temp', 'rain_probability', 'condition', 'caution', 'preventive_gear', 'activity_advice'),\n"

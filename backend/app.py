    ...
    try:
        ...
        if is_gagansaathi or (from_airport and to_airport):
            prompt = (
                ...
                f"### INSTRUCTIONS FOR YOUR RESPONSE (WRITE IN DETAILED NARRATIVE PARAGRAPHS - NO SHORT 1-LINE BULLETS):\n"
                f"Deliver a warm, highly detailed, beautifully written response in complete, comprehensive narrative paragraphs for each section:\n\n"
                ...
                f"1. ✈️ **Trip Overview & Flight Logistics Roadmap**:\n"
                f"   Write a detailed paragraph explaining the estimated geodesic distance, direct cruising duration (~1h 30m), pre-departure preparation (starting from home with traffic buffer, 24h web check-in, saving digital boarding passes, keeping government photo ID ready, and packing powerbanks strictly in hand luggage). Detail the origin airport sequence (entry gate verification, baggage drop counter protocol, CISF security trays with electronics separated, and boarding on call) and destination airport arrival (following baggage claim signs to the flight carousel, collecting bags, and choosing transit between Destination Metro lines, official prepaid airport taxi kiosks, and app-based cab pickup zones).\n\n"
                f"2. 🌤️ **Weather Prediction & Preventive Gear Advisory**:\n"
                f"   Write a detailed paragraph providing the day-by-day forecast for **{trip_days}** with temperatures, precipitation chances, and sky conditions. Explicitly recommend essential gear (such as umbrellas, raincoats, UV sunglasses, sunscreen, or light jackets) and provide weather-adaptive activity guidance (e.g. indoor museums for rainy hours, shaded morning/sunset visits for sunny hours, and scenic lakes for pleasant weather).\n\n"
                f"3. 🏥 **Emergency Helplines & Nearest 24/7 Hospitals**:\n"
                f"   Write a paragraph listing official national emergency helplines (Police: `100`/`112`, Ambulance: `108`, Women Safety: `181`, Airport Security) and detail 3 top multi-specialty emergency hospitals near the airport and downtown with 24/7 helplines, trauma care, and distances.\n\n"
                f"4. 🏨 **Nearest Hotel & Living Accommodations**:\n"
                f"   Write a comprehensive paragraph reviewing 3 top-rated hotels matching the budget tier ({budget or 'Moderate'}). Detail their approximate distances from the destination airport, key amenities, nightly tariffs, weather-proof AC comfort, and why they are ideal for the stay.\n\n"
                f"5. 🍽️ **Famous Local Foods, Restaurants & Allergy Advisory**:\n"
                f"   Write a rich paragraph reviewing 3 renowned foodlets and dining spots near the destination airport and city center. Tailor recommendations strictly to **{food_pref or 'all dietary preferences'}** and provide strict allergy precautions for **{allergies or 'general safety'}** with signature safe dishes and advice on instructing restaurant staff.\n\n"
                f"6. 🛡️ **Night Safety & Crime Advisory Handbook**:\n"
                f"   Write an honest narrative paragraph covering destination safety around the airport and city after dark. Detail essential safety DOs and critical DON'Ts, verified transit precautions, avoiding isolated dark areas, and staying vigilant.\n\n"
                f"7. 📍 **Famous Viewpoints & Top City Attractions**:\n"
                f"   Write a descriptive paragraph detailing top iconic viewpoints, cultural landmarks, and sightseeing attractions with optimal visiting hours, metro connectivity, and weather suitability.\n\n"
                ...
                f"'foodlets': array of objects with ('name', 'type' ('Veg'/'Non-Veg'/'Multi'), 'cuisine', 'special_dish', 'price_range', 'weather_tag', 'why_recommended', 'cautions_requirements', 'map_query'),\n"
